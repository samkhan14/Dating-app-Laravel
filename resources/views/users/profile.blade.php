    ...
    <div class="container">
        ...
        <div class="card social-prof">
            <div class="card-body">
                ...
                <div class="wrapper">
                    <img src=" {{ asset('img/frontend_images/photos/'.$user_photo) }}" alt="" class="user-profile">
                    <h3>{{$user_detail->name}}</h3>
                    <p>{{$user_detail->details->about_myself}}</p>
                </div>
                @else
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card">
                    <div class="card-body">
                        <div class="h5 text-blue">@ {{$user_detail->details->username}}</div>
                        <div class="h7 "><strong>Lives in :</strong> {{ $user_detail->details->country }}</div>
                        <div class="h7 "><strong>Marital Status :</strong> {{$user_detail->details->marital_status}}</div>
                        <div class="h7"><strong>Gender :</strong>  {{$user_detail->details->gender}} </div>
                        <div class="h7"><strong>Education :</strong> {{$user_detail->details->education}} </div>
                    </div>
